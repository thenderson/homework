<?php
    ...
    //TODO ability to sort & filter
        ...
        $planning_horizon = 14;
        $commitments = $comm_db->query("SELECT * FROM commitments WHERE due_by <= DATE_ADD(CURDATE(), INTERVAL {$planning_horizon} DAYS), ORDER BY promiser, project_number, due_by");
